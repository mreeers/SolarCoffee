    ...
    public partial class ProductInventorySales : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelesOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelesOrders_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    SelesOrderId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelesOrderItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelesOrderItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelesOrderItems_SelesOrders_SelesOrderId",
                        column: x => x.SelesOrderId,
                        principalTable: "SelesOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelesOrderItems_ProductId",
                table: "SelesOrderItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SelesOrderItems_SelesOrderId",
                table: "SelesOrderItems",
                column: "SelesOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_SelesOrders_CustomerId",
                table: "SelesOrders",
                column: "CustomerId");
        }
